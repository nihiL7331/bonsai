...
const SCENE_OUT_DIR: &str = "bonsai/types/game/generated_scene.odin";
...
pub fn generate_sprite_metadata(
    ...
    odin_code.push_str("import \"bonsai:types/gmath\"\n\n");
...
fn generate_scene_registry_metadata(scene_src: &str, scene_out: &str) -> Result<(), CustomError> {
    ...
    odin_code.push_str("import \"bonsai:types/game\"\n");
    odin_code.push_str("\n");
    odin_code.push_str("_ :: scene\n");
    odin_code.push_str("_ :: game\n");
    odin_code.push_str("\n");
