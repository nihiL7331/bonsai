...
pub fn generate_sprite_metadata(
    ...
    odin_code.push_str("// @ref\n");
    odin_code.push_str("// Function used internally to get [`SpriteData`](#spritedata) from a [`SpriteName`](#spritename) enum.\n");
    ...
    odin_code.push_str("// @ref\n");
    odin_code.push_str("// Returns amount of frames a [`SpriteName`](#spritename) contains.\n");
    odin_code.push_str("// Returns `1` if the sprite **isn't** animated.\n");
...
pub fn generate_empty_sprite_metadata() -> Result<(), CustomError> {
    ...
    odin_code.push_str("// This package contains all of the auto-generated data at build-time. Currently it stores:\n");
    odin_code.push_str("// - **Sprite data:** Assigns **atlas UV** and **image size in pixels** to every **PNG** image from **assets/images**.\n");
    odin_code.push_str("//   Manages animation and tileset data. More information on that topic can be found in the [`bonsai:core/render`](https://bonsai-framework.dev/reference/core/render) package overview.\n");
    odin_code.push_str("// - **Font data:** Grabs **TTF** files present in the `assets/fonts` directory, generates bitmap using the [`stb`](https://github.com/nothings/stb) library.\n");
    odin_code.push_str(
        "//   Makes the fonts easily accessible with the [`FontName`](#fontname) enum.\n",
    );
    odin_code.push_str("// - **Audio data:** Grabs **WAV** files present in the `assets/audio` directory and links each sound to a [`AudioName`](#audioname) enum.\n");
    odin_code.push_str("// - **Scene data:** Generates a registry in the `source/game/scenes` directory, which registers all created scenes. Using directory names, generates\n");
    odin_code.push_str("//   a [`SceneName`](#scenename) enum to access them. Example usage can be found in the [`bonsai:core/scene`](https://bonsai-framework.dev/reference/core/scene) package overview.\n");
